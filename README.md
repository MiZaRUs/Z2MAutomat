...
## ВАЖНО!
## Всё это рассчитано на работу в локальной сети, так-как доступы не защищены! Если нужен внешний доступ, обязательно позаботьтесь о защищенном шлюзе.
...
Важные сообщения можно отправить на мобильное устройство. Так-же можно некоторые данные отправить по UDP в сервис мониторинга.
...
БД встроенная. Хранение данных ограничено по времени, свежие повторы значений при записи - игнорируются.
...
## Скрипты компиляции, сборки контейнера и деплоя (требуется go)
